...
const Files = () => {
  ...
  const allowedFileNames = ['SERVICES_1', 'SERVICES_2', 'SERVICES_3'];
  const NotallowedFileNames = ['Background Header', 'Video Summary', 'CPT3', 'CPT3XL', 'Compact', 'Tabletop', 'PLD_3D', '3Dpads','PCB', 'MultiScale', 'Sensor', 'Fringes', 'Chips', 'COMPACT 2', 'COMPACT 3', 'COMPACT 3XL', 'TABLE TOP', 'RT 3D SENSOR'];
