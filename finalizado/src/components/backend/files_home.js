...
const Files_home = () => {
  ...
  const allowedFileNames = ['Background Header', 'Video Summary', 'CPT3', 'CPT3XL', 'Compact', 'Tabletop', 'PLD_3D', '3Dpads','PCB', 'MultiScale', 'Sensor', 'Fringes', 'Chips'];
