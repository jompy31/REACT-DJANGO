...
import Image1 from '../../assets/IMAGO/Pics/CPT (3).png';
import imageexpanded from '../../assets/IMAGO/pdf/compact3-xl.jpg';
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>800 x 600 mm</TableCell>
                </TableRow>

                <TableRow>
                  <TableCell style={{fontWeight: 'bold'}}>Field of view</TableCell>
                  <TableCell>Adjustable Zoom from 20 x 24 to 640 x 470 mmm</TableCell>
                </TableRow>
                ...
                <TableRow>
                  ...
                  <TableCell>up to +1.5°C/s</TableCell>
                </TableRow>

                <TableRow>
                  <TableCell style={{fontWeight: 'bold'}}>Cooling rate</TableCell>
                  <TableCell>Up to -1.5°/s</TableCell>
                </TableRow>

                <TableRow>
                  <TableCell style={{fontWeight: 'bold'}}>Footprint</TableCell>
                  <TableCell>300 cm x 120 cm x 198 cm</TableCell>
                </TableRow>
